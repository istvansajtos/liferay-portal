...
public class SystemPortletsResourcePermissionsUpgradeProcess
	...
	protected void doUpgrade() throws Exception {
		CompanyLocalServiceUtil.forEachCompanyId(
			companyId -> _removeResourcePermissions(
				companyId, _APPLICATIONS_MENU_PORTLETS, _getRoleId(companyId,
				RoleConstants.GUEST)));

		CompanyLocalServiceUtil.forEachCompanyId(
			companyId -> _removeResourcePermissions(
				companyId, _PRODUCT_MENU_PORTLETS, _getRoleId(companyId,
				RoleConstants.GUEST)));
	}

	private long _getRoleId(long companyId, String roleName) throws Exception {
	...
	private void _removeResourcePermissions(
			long companyId, String[] portlets, long roleId)
		throws Exception {
	...
	private static final String[] _APPLICATIONS_MENU_PORTLETS = new String[]{
	...
	private static final String[] _PRODUCT_MENU_PORTLETS = new String[] {
		//Product Menu
		//============
		//Design:
	...
	private static final String[] _MISC = new String[] {
		//User Profile Menu
		//=================
