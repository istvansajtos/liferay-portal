...
public class RoleUtil {
	...
	private static List<Group> _getAllGroups(User user) throws Exception {
		...
		allGroups.addAll(
			GroupLocalServiceUtil.getOrganizationsGroups(_getOrganizations(user)));
		allGroups.addAll(
	...
	private static List<Group> _getInheritedSiteGroups(User user) throws Exception {
		SortedSet<Group> inheritedSiteGroupsSet = new TreeSet<>();

		inheritedSiteGroupsSet.addAll(
			GroupLocalServiceUtil.getUserGroupsRelatedGroups(_getUserGroups(user)));
	...
	private static List<Organization> _getOrganizations(User user) throws Exception {
		PermissionChecker permissionChecker =
			PermissionThreadLocal.getPermissionChecker();
