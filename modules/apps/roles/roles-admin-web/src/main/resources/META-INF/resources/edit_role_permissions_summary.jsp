	...
	<div class="sheet-section">
		...
		for (int i = 0; i < results.size(); i++) {
			...
			if (role.getType() == RoleConstants.TYPE_REGULAR) {
				...
				groups = GroupLocalServiceUtil.search(company.getCompanyId(), new long[] {PortalUtil.getClassNameId(Company.class), PortalUtil.getClassNameId(Group.class)}, null, null, groupParams, true, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
