...
public class CommentManagerJSONWSImpl
	...
	implements AopService, CommentManagerJSONWS, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CommentManagerJSONWS.class, IdentifiableOSGiService.class
		};
	}
	...
	public String getOSGiServiceIdentifier() {
		return CommentManagerJSONWS.class.getName();
	}
